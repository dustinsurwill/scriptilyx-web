 ...
 * as-is — no parameters, no modal. See src/data/wizardTemplates.ts for the
 * parameterized counterpart; the two are deliberately separate systems
 * (static worked examples here vs. fill-in-the-blanks practical scripts
 * there), sharing only the mechanical graph-assembly step. */
